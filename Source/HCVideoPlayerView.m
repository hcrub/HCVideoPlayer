...
@implementation HCVideoPlayerView

- (id)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        _airplayIsActiveView = [[HCActiveAirplayView alloc] initWithFrame:CGRectZero];
